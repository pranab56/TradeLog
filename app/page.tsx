    ...
    <MainLayout>
      <div className="space-y-8 pb-10">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
          <div>
            <h1 className="text-3xl font-bold tracking-tight mb-1">Trading Performance</h1>
            <p className="text-muted-foreground">Comprehensive analysis of your capital and growth strategies.</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            <Card className="bg-primary p-6 rounded-3xl text-primary-foreground shadow-xl shadow-primary/20 flex flex-col justify-between overflow-hidden relative border-none">
              ...
              <div>
                <h4 className="text-lg font-bold mb-2">Portfolio Stats</h4>
          ...
          <Tabs defaultValue="daily" onValueChange={setActiveTab} className="w-full">
            <div className="flex items-center justify-between mb-4">
              ...
              <TabsList className="bg-card border border-border p-1 rounded-xl h-auto">
                <TabsTrigger value="daily" className="rounded-lg py-2 px-4 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">Daily</TabsTrigger>
                <TabsTrigger value="monthly" className="rounded-lg py-2 px-4 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">Monthly</TabsTrigger>
                <TabsTrigger value="yearly" className="rounded-lg py-2 px-4 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">Yearly</TabsTrigger>
              </TabsList>
            </div>
